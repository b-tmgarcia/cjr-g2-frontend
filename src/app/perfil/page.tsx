...
export default function Perfil() {
  ...
  const [isEditarPerfilOpen, setIsEditarPerfilOpen] = React.useState(false);

  const openModalEditarPerfil = () => {
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex flex-col items-start gap-6 flex-1 min-w-0">
              ...
              <div className="pt-4 text-left min-w-0">
                <h1 className="text-4xl font-bold text-gray-900">{user.nome}</h1>
                <p className="text-gray-500 mt-1">{user.instagram}</p>
